...
public class ArtifactProfileGraphReaderTest {
    ...
    @Test
    public void testCreateArtifactInputOutput() {
      ...
      final var signifier = new Signifier.Builder(actionSpecification.build())
        ...
        ResourceProfile profile1 = ResourceProfileGraphReader.readFromString(test);
    }

    @Test
    public void testReadFromFile() throws IOException {
        // read in the file from the resources folder
        ResourceProfile profile = ResourceProfileGraphReader.readFromFile("src/test/resources/artifact-profile-adder-valid.ttl");
        ResourceProfile failure = ResourceProfileGraphReader.readFromFile("src/test/resources/artifact-profile-adder.ttl");
